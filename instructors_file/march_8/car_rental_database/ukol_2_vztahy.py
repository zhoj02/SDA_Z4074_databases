...
for client in clients:
    insert_data(session=session, base=Clients, params=client)

for car in cars:
    insert_data(session=session, base=Cars, params=car)

for booking in bookings:
    insert_data(session=session, base=Bookings, params=booking)